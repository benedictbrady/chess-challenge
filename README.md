...
The quiescence search is identical for your NN and the baseline — only captures and promotions are followed (no check extensions, no delta pruning). Each root move gets a full-window search. The only variable is your eval function.
